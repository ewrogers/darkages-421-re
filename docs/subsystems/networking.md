...
The directional action indexes are [Client actions](../protocol/client-actions.md) and [Server actions](../protocol/server-actions.md). Each index links to one payload-relative page per action.
...
See [Sequence and XOR Transformation](../protocol/xor-transformation.md) for the exact wire placement, pass order, negotiation payload, all ten table formulas, and implementation addresses.
