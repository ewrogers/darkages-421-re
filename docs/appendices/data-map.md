...
| `Darkages.exe:0x004FD5E0` | `net_send_sequence` | `uint8_t` | Socket transformation | Sequence inserted after ordinary client actions. | [Networking](../subsystems/networking.md#sequence-and-xor-transformation) | Incremented modulo 256. |
