...
[Previous: SSelfSaveOk](033-21-self-save-ok.md) | [Server action index](../server-actions.md) | [Next: SEffectLayer](041-29-effect-layer.md)

`SActionChange` is the supplied later-client message name for server-direction action `0x26`. It is not RTTI or a symbol recovered from the 4.21 executable.
