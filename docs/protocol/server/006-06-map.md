...
[Previous: SUserAppearance](005-05-user-appearance.md) | [Server action index](../server-actions.md) | [Next: SDrawObjects](007-07-draw-objects.md)

`SMap` is the supplied later-client message name for server-direction action `0x06`. It is not RTTI or a symbol recovered from the 4.21 executable.
