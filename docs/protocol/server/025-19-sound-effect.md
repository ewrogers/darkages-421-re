...
[Previous: SRemoveSpell](024-18-remove-spell.md) | [Server action index](../server-actions.md) | [Next: SMotion](026-1a-motion.md)

`SSoundEffect` is the supplied later-client message name for server-direction action `0x19`. It is not RTTI or a symbol recovered from the 4.21 executable.
