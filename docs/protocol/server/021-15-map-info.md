...
[Previous: SDamageEffect](019-13-damage-effect.md) | [Server action index](../server-actions.md) | [Next: SAddSpell](023-17-add-spell.md)

`SMapInfo` is the supplied later-client message name for server-direction action `0x15`. It is not RTTI or a symbol recovered from the 4.21 executable.
