...
[Previous: SEffectLayer](041-29-effect-layer.md) | [Server action index](../server-actions.md) | [Next: SRemoveContainer](043-2b-remove-container.md)

`SAddContainer` is the supplied later-client message name for server-direction action `0x2A`. It is not RTTI or a symbol recovered from the 4.21 executable.
