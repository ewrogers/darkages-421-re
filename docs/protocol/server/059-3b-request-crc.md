...
[Previous: SSpelled](058-3a-spelled.md) | [Server action index](../server-actions.md) | [Next: SMapPart](060-3c-map-part.md)

`SRequestCRC` is the supplied later-client message name for server-direction action `0x3B`. It is not RTTI or a symbol recovered from the 4.21 executable.
