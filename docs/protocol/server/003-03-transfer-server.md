...
[Previous: SLoginCheck](002-02-login-check.md) | [Server action index](../server-actions.md) | [Next: SUserPosition](004-04-user-position.md)

`STransferServer` is the supplied later-client message name for server-direction action `0x03`. It is not RTTI or a symbol recovered from the 4.21 executable.
