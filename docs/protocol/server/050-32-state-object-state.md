...
`SStateObjectState` is the supplied later-client message name for server-direction action `0x32`. It is not RTTI or a symbol recovered from the 4.21 executable.
