...
[Previous: SSoundEffect](025-19-sound-effect.md) | [Server action index](../server-actions.md) | [Next: SEnterEditingMode](027-1b-enter-editing-mode.md)

`SMotion` is the supplied later-client message name for server-direction action `0x1A`. It is not RTTI or a symbol recovered from the 4.21 executable.
