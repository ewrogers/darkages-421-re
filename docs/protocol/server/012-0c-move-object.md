...
[Previous: SMove](011-0b-move.md) | [Server action index](../server-actions.md) | [Next: SSay](013-0d-say.md)

`SMoveObject` is the supplied later-client message name for server-direction action `0x0C`. It is not RTTI or a symbol recovered from the 4.21 executable.
