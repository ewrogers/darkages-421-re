...
[Previous: SRemoveSkill](045-2d-remove-skill.md) | [Server action index](../server-actions.md) | [Next: SScreenMenu](047-2f-screen-menu.md)

`SFieldMap` is the supplied later-client message name for server-direction action `0x2E`. It is not RTTI or a symbol recovered from the 4.21 executable.
