...
The `C...` class names identify the 51 fixed client-to-server actions found in the traced 4.21 send path. No additional fixed client action was found. The spelling `CNewUserApperance` is the 4.21 class name.
...
| `0x18` | [`CWho`](client/024-18-who.md) | Yes | `Darkages.exe:0x0043E39C`. Payload semantics are not yet established. |
| `0x19` | [`CWhisper`](client/025-19-whisper.md) | Yes | `Darkages.exe:0x004C1182`. Payload semantics are not yet established. |
| `0x1B` | [`CUserSetting`](client/027-1b-user-setting.md) | Yes | `Darkages.exe:0x00491AC4`. Payload semantics are not yet established. |
...
| `0x23` | [`CExitEditingMode`](client/035-23-exit-editing-mode.md) | Yes | `Darkages.exe:0x00493C99`, `Darkages.exe:0x0049421C`. Used for paper editing. |
...
| `0x2D` | [`CSelfLook`](client/045-2d-self-look.md) | Yes | `Darkages.exe:0x0043D4DC`. Payload semantics are not yet established. |
...
| `0x3E` | [`CUseSkill`](client/062-3e-use-skill.md) | Yes | `Darkages.exe:0x00454C96`. Payload semantics are not yet established. |
...
| `0x4D` | [`CSpellDelayRequest`](client/077-4d-spell-delay-request.md) | Yes | `Darkages.exe:0x00455CDF`. Payload semantics are not yet established. |
